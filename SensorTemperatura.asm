...
L_Display_Temperature34:
	...
	MOVWF       R1 
	MOVF        R2, 0 
L__Display_Temperature60:
	BZ          L__Display_Temperature61
	RRCF        R1, 1 
	RRCF        R0, 1 
	BCF         R1, 7 
	ADDLW       255
	GOTO        L__Display_Temperature60
...
L__Display_Temperature62:
	BZ          L__Display_Temperature63
	RLCF        R0, 1 
	BCF         R0, 0 
	RLCF        R1, 1 
	ADDLW       255
	GOTO        L__Display_Temperature62
